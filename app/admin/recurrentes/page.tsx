        ...
        <div className="p-4 md:p-8 max-w-screen-xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-7">
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 flex items-start gap-4 hover:shadow-md transition-shadow">
                    ...
                    <div>
                        <p className="text-xs font-medium text-gray-400 uppercase tracking-wide">Usuarios recurrentes</p>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 flex items-start gap-4 hover:shadow-md transition-shadow">
                    ...
                    <div>
                        <p className="text-xs font-medium text-gray-400 uppercase tracking-wide">Pagos totales</p>
                        <p className="text-2xl font-bold text-gray-800 mt-0.5">{totalPayments}</p>
                    </div>
                </div>
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 flex items-start gap-4 hover:shadow-md transition-shadow">
                    ...
                    <div>
                        <p className="text-xs font-medium text-gray-400 uppercase tracking-wide">Revenue recurrentes</p>
                        <p className="text-2xl font-bold text-gray-800 mt-0.5">${(totalRevenue / 100).toFixed(2)}</p>
                    </div>
                </div>
            </div>
